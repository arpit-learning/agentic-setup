...
describe('streamGeneration inactivity timeout', () => {
  ...
  beforeEach(() => {
    ...
    process.env.AGENTIC_SETUP_STREAM_INACTIVITY_TIMEOUT_MS = '10000';
  });
...
describe('streamGeneration total timeout', () => {
  ...
  it('triggers even when model keeps producing output', async () => {
    process.env.AGENTIC_SETUP_STREAM_INACTIVITY_TIMEOUT_MS = '60000';
    process.env.AGENTIC_SETUP_GENERATION_TIMEOUT_MS = '30000';
  ...
  it('calls onError immediately when total timeout fires', async () => {
    process.env.AGENTIC_SETUP_GENERATION_TIMEOUT_MS = '5000';
...
describe('refineSetup inactivity timeout', () => {
  ...
  it('respects custom timeout from env var', async () => {
    process.env.AGENTIC_SETUP_STREAM_INACTIVITY_TIMEOUT_MS = '5000';
...
describe('buildDiagnostic', () => {
  ...
  it('reports inactivity timeout with zero output', () => {
    ...
    expect(msg).toContain('AGENTIC_SETUP_STREAM_INACTIVITY_TIMEOUT_MS');
  });
  ...
  it('reports total timeout', () => {
    ...
    expect(msg).toContain('AGENTIC_SETUP_GENERATION_TIMEOUT_MS');
  });
