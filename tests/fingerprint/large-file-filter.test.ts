...
import { filterIgnoredWarnings } from '../../src/fingerprint/large-file-filter.js';
import type { LargeFileWarning } from '../../src/fingerprint/large-file-scan.js';
...
describe('filterIgnoredWarnings', () => {
  ...
  // ── agentic-setupignore filter ─────────────────────────────────────────────────

  it('filters files matching .agentic-setupignore patterns', () => {
  ...
  it('supports glob patterns in .agentic-setupignore', () => {
    const warnings = [
  ...
  it('skips comments and empty lines in .agentic-setupignore', () => {
    const warnings = [makeWarning(DIR, 'data/dump.sqlite'), makeWarning(DIR, 'assets/video.mp4')];
  ...
  it('keeps all warnings when .agentic-setupignore does not exist', () => {
  ...
  it('filters via both gitignore and agentic-setup ignore patterns', () => {
    const warnings = [
