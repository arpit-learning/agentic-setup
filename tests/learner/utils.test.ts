...
import { normalizeBullet, hasTypePrefix, isSimilarLearning, extractScope } from '../../src/learner/utils.js';
...
describe('normalizeBullet', () => {
  ...
  it('handles combined transformations', () => {
    expect(normalizeBullet('- **[Fix]** Always run `npm ci` before deploying')).toBe(
