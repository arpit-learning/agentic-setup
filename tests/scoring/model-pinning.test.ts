...
import { configContentSuggestsPinnedModel } from '../../src/scoring/model-pinning.js';
...
describe('configContentSuggestsPinnedModel', () => {
  it('detects AGENTIC_SETUP_MODEL and AGENTIC_SETUP_FAST_MODEL', () => {
    expect(pinned('Set AGENTIC_SETUP_MODEL for this repo.')).toBe(true);
    expect(pinned('use agentic_setup_fast_model for quick tasks')).toBe(true);
  });
