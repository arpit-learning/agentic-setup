...
import { checkGrounding } from '../../src/scoring/checks/grounding.js';
import { collectProjectStructure } from '../../src/scoring/utils.js';
...
describe('checkGrounding', () => {
  ...
  beforeEach(() => {
    dir = mkdtempSync(join(tmpdir(), 'agentic-grounding-'));
...
describe('collectProjectStructure respects .gitignore', () => {
  ...
  beforeEach(() => {
    dir = mkdtempSync(join(tmpdir(), 'agentic-gitignore-'));
