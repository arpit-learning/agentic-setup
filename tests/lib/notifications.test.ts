...
const tmpBase = fs.mkdtempSync(path.join(os.tmpdir(), 'agentic-notif-test-'));
...
import { writeFinalizeSummary, checkPendingNotifications } from '../../src/lib/notifications.js';
import type { FinalizeSummary } from '../../src/lib/notifications.js';
