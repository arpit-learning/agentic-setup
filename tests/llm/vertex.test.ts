...
import fs from 'fs';
import { VertexProvider } from '../../src/llm/vertex.js';
...
describe('VertexProvider constructor', () => {
  ...
  it('reads credentials from file path', () => {
    ...
    expect(MockGoogleAuth).toHaveBeenCalledWith(expect.objectContaining({ credentials: creds }));
  });
