...
import { collectFilesToWrite, refreshCommand } from '../../src/commands/refresh.js';
...
describe('refreshCommand hook-cascade short-circuit (F-P0-9)', () => {
  ...
  it('does NOT short-circuit when --quiet but in agentic-spawned claude session', async () => {
    process.env.CLAUDECODE = '1';
