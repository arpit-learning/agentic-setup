 ...
 * "literal X" — so a Windows path like `C:\Users\foo\agentic-setup.cmd` becomes
 * `C:Usersfooagentic-setup.cmd` after quote-removal. Replacing all backslashes with
 * forward slashes (`C:/Users/foo/agentic-setup.cmd`) sidesteps this: Git Bash and
