...
vi.mock('../hooks.js', () => ({ hooksCommand: mocks.hooksCommand }));
vi.mock('../init.js', () => ({ initCommand: mocks.initCommand }));
vi.mock('../codegraph.js', () => ({ codegraphSetupCommand: mocks.codegraphSetupCommand }));
vi.mock('../analyze.js', () => ({ analyzeCommand: mocks.analyzeCommand }));
vi.mock('../composite-score.js', () => ({ compositeScoreCommand: mocks.compositeScoreCommand }));
