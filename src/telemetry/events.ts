...
export function trackInitProviderSelected(
  provider: string,
  model: string,
  isFirstRun?: boolean,
): void {
...
export function trackInitProjectDiscovered(
  languageCount: number,
  dependencyCount: number,
  fileCount: number,
): void {
  trackEvent('init_project_discovered', {
...
export function trackInitScoreComputed(
  score: number,
  passingCount: number,
  failingCount: number,
  earlyExit: boolean,
): void {
  trackEvent('init_score_computed', {
    score,
...
export function trackInitFilesWritten(
  fileCount: number,
  createdCount: number,
  modifiedCount: number,
  deletedCount: number,
): void {
  trackEvent('init_files_written', {
    file_count: fileCount,
...
export function trackRefreshCompleted(
  changesCount: number,
  durationMs: number,
  trigger?: 'hook' | 'manual' | 'ci',
): void {
