...
import { AUTH_DIR, GITHUB_REPO_URL, PERSONAL_LEARNINGS_FILE } from '../constants.js';

const LEARNINGS_FILE = 'AGENTIC_LEARNINGS.md';
const LEARNINGS_HEADER = `# agentic-setup Learnings

Accumulated patterns and anti-patterns from development sessions.
Auto-managed by [agentic-setup](${GITHUB_REPO_URL}) — do not edit manually.
...
const LEARNED_START = '<!-- agentic:learned -->';
const LEARNED_END = '<!-- /agentic:learned -->';
...
/** Migrate learned content from inline CLAUDE.md section to AGENTIC_LEARNINGS.md. */
